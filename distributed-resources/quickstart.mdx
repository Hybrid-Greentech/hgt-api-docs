...
<Tabs>
  ...
  <Tab title="PV">
    ...
    This roof has two faces, so it declares two module groups. Their 7.4 kWp of DC capacity exceeds the 6 kW inverter, which is normal — the surplus is clipped. `systemLoss` is optional, and the platform applies `0.14` when you omit it.
...
<Tabs>
  <Tab title="EV charger">
    ...
    A charge point drawing 7.2 kW of an 11 kW maximum publishes three metrics and no site metering. The headroom values are the consumption it can shed and the consumption it can add, both measured from `-7.2` kW.
  ...
  <Tab title="Heat pump">
    ...
    A heat pump running its compressor at 3 kW of a 9 kW maximum publishes the same three power metrics plus the site meter. `resourceTimestamp` is `null` on the site metrics, because the meter has no trusted clock of its own.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ16",
      "resourceId": "hp-site-b-01",
      "measurementType": "siteImport",
      "value": 4.1,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ17",
      "resourceId": "hp-site-b-01",
      "measurementType": "siteExport",
      "value": 0,
      "unit": "kW",
      "resourceTimestamp": null,
      "serverTimestamp": 1788344077549
  ...
  <Tab title="Battery">
    ...
    A battery discharging 4.2 kW at 94% state of charge publishes all eight metrics. `measuredPower` is positive because the battery is exporting, and the energy metrics are independent of `stateOfCharge` — at 94% there is little left to absorb.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ21",
      "resourceId": "bess-site-c-01",
      "measurementType": "siteImport",
      "value": 0,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ22",
      "resourceId": "bess-site-c-01",
      "measurementType": "siteExport",
      "value": 3.9,
      "unit": "kW",
  ...
  <Tab title="CHP">
    ...
    A CHP exporting 4.5 kW of a 9 kW maximum publishes the same five metrics as a heat pump. `measuredPower` is positive because the unit is exporting, and the headroom values are the output it can add and the output it can drop.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ29",
      "resourceId": "chp-site-d-01",
      "measurementType": "siteImport",
      "value": 0,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ30",
      "resourceId": "chp-site-d-01",
      "measurementType": "siteExport",
      "value": 4.3,
      "unit": "kW",
  ...
  <Tab title="P2X">
    ...
    A P2X plant drawing 30 kW of a 50 kW maximum publishes the same five metrics. It can shed all 30 kW of consumption and add 20 kW more.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ34",
      "resourceId": "p2x-site-e-01",
      "measurementType": "siteImport",
      "value": 31.2,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ35",
      "resourceId": "p2x-site-e-01",
      "measurementType": "siteExport",
      "value": 0,
      "unit": "kW",
  ...
  <Tab title="PV">
    ...
    A rooftop array producing 4.2 kW through a 6 kW inverter publishes the same five metrics as a heat pump. `measuredPower` is positive because the array is generating, and it reports AC production at the inverter output whether that power reaches the grid or is consumed on site.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ45",
      "resourceId": "pv-site-g-01",
      "measurementType": "siteImport",
      "value": 0,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ46",
      "resourceId": "pv-site-g-01",
      "measurementType": "siteExport",
      "value": 3.1,
      "unit": "kW",
    ...
    The site consumes 1.1 kW of the 4.2 kW produced, so 3.1 kW reaches the meter. Add a battery to this site absorbing 3 kW and nothing about the array's measurements changes: the array still publishes `4.2`, the battery publishes `-3` on its own topic as a separate `bess` resource, and `siteExport` falls to `0.1`.

  </Tab>
  <Tab title="Other">

    A `misc` resource publishes the same five metrics, whatever the equipment is. The platform reads the metrics, not the equipment class.
    ...
    ```json title="siteImport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ39",
      "resourceId": "misc-site-f-01",
      "measurementType": "siteImport",
      "value": 8.4,
      "unit": "kW",
    ...
    ```json title="siteExport"
    {
      "messageId": "01ABCDEFGHJKMNPQRSTVWXYZ40",
      "resourceId": "misc-site-f-01",
      "measurementType": "siteExport",
      "value": 0,
      "unit": "kW",
...
|----------------|-----------|
| `evCharger` | `measuredPower`, `availablePowerUp`, `availablePowerDown` |
| `heatPump` | The above three, plus `siteImport` and `siteExport` |
| `chp` | The same five as `heatPump` |
| `p2x` | The same five as `heatPump` |
| `pv` | The same five as `heatPump` |
| `misc` | The same five as `heatPump` |
| `bess` | The same five, plus `stateOfCharge`, `availableEnergyUp`, and `availableEnergyDown` |
