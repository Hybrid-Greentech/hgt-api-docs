...
<Warning>
  This API is deprecated. New integrations use the [Distributed Energy Resources API](/distributed-resources/quickstart) on the `v2` topic prefix. This version stays fully operational for existing integrations and no sunset date is set. See [Migrating to v2](/distributed-resources/migration).
</Warning>
